...
[0] = LAYOUT_65_ansi(
  ...
  KC_LSFT, KC_Z,    KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,         KC_PGUP,   KC_F1,           \
  KC_LCTL, KC_LGUI, KC_LALT,                KC_SPC,                          MO(1), KC_HOME,   KC_END, KC_MPLY, KC_PGDN, KC_F2
  ),
